# -*- coding: utf-8 -*-
"""
Functions for creating submissions to the LoDoPaB-CT challenge.

This file is a clone of
`https://github.com/jleuschn/lodopab_challenge/blob/master/submission.py`_.
